...
def flask_app():
    ...
    PLAID_CLIENT_ID = '654c9d4bed7858001c0b316a'
    PLAID_SECRET = 'a14b30341102b414f8ea19a78345bb'
    ...
    #A method used to generate access token, for testing only
    @app.route('/api/generate_access_token', methods=['POST'])
